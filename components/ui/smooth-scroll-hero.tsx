        ...
        >
          <div className="text-center text-white max-w-4xl mx-auto px-6">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-gray-200 mb-8 leading-relaxed font-medium">
              AI-powered video analysis for every athlete. Upload. Analyze. Improve.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Athletes Empowered</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Training Locations</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Days of Progress</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Personal Bests</div>
              </div>
            </div>
            ...
            <div className="mt-12 pt-6 border-t border-white/20">
              <p className="text-xs text-gray-400 mb-3 font-medium">TRUSTED BY ATHLETES AND COACHES</p>
              <div className="flex flex-wrap justify-center items-center gap-4 text-gray-300">
                <span className="text-xs font-semibold">🤝 COACH-LED GUIDANCE</span>
                <span className="text-xs font-semibold">🧠 AI-POWERED INSIGHTS</span>
                <span className="text-xs font-semibold">🏅 RESULTS-DRIVEN TRAINING</span>
