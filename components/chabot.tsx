  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "bot",
      content:
        "Hi! I'm Pragati, your sports empowerment assistant. Ask about programs, impact, donations, volunteering, or how we help young athletes.",
    },
  ])
                ...
                <CardFooter>
                  <form onSubmit={handleSubmit} className="flex w-full items-center space-x-2">
                    <Input
                      ...
                      placeholder="Ask about Pragati programs, impact, donations, volunteering..."
                      disabled={isLoading}
                      className="flex-1"
                    />
